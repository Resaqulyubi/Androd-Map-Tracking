        ...
        revGecodeRequest.execute(new ResultListener<Location>() {
            ...
            public void onCompleted(Location location, ErrorCode errorCode) {
                if (errorCode == ErrorCode.NONE) {
                    ...
                    Toast.makeText(BasicPositioningActivity.this, location.getAddress().getText(), Toast.LENGTH_SHORT).show();

//                    updateTextView(location.getAddress().toString());
                } else {
                    Toast.makeText(BasicPositioningActivity.this, "not get location info", Toast.LENGTH_SHORT).show();
